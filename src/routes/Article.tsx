...
function Article() {
  ...
  return (
    <Container className="page">
      <Seo
        title={articleData.attributes.seo.metaTitle}
        description={articleData.attributes.seo.metaDescription}
      />
      ...
      <Image
        ...
        alt={articleData.attributes.image.data.attributes.alternativeText}
        fluid
      />
